...
$(INSTALLED_BOOTIMAGE_TARGET): $(recovery_ramdisk) $(INSTALLED_RAMDISK_TARGET) $(PRODUCT_OUT)/utilities/busybox $(MKBOOTIMG) $(MINIGZIP) $(INTERNAL_BOOTIMAGE_FILES)
	...
	$(hide) cp -r $(LOCAL_PATH)/prebuilt/sbin/* $(PRODUCT_OUT)/root/sbin/
	$(hide) cp -r $(PRODUCT_OUT)/root/* $(PRODUCT_OUT)/combinedroot/
	$(hide) cp -r $(PRODUCT_OUT)/root/sbin/* $(PRODUCT_OUT)/combinedroot/sbin/
