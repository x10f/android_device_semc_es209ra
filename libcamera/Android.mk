...
LOCAL_SRC_FILES:= mSemcCameraHardware.cpp
...
LOCAL_CFLAGS+= -DNUM_PREVIEW_BUFFERS=4 -D_ANDROID_ -DQCOM_HARDWARE
...
LOCAL_MODULE:= libcamerafromsemc
...
LOCAL_SHARED_LIBRARIES := liblog libdl libutils libcamera_client libbinder libcutils libhardware libui libcamerafromsemc
